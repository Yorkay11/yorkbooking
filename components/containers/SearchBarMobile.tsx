...
const SearchBarMobile = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-transparent backdrop-blur flex">
            <div className="container mx-auto px-4 flex flex-row flex-wrap justify-between items-center ">
                <div
